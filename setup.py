...
packages = [package for package in find_packages() if package.startswith("smg_gym")]
...
setup(name='smg_gym',
      version='0.0.1',
      description='Isaavgym environments with the shadow modular grasper',
      author='Alex Church',
      author_email='alexhurch1993@gmail.com',
      license='MIT',
      packages=packages,
      package_data={'smg_gym': data_files},
